...
_ENV_OVERRIDES: dict[str, str] = {
    ...
    # Auth OIDC
    "CODEX_AUTH_OIDC_ENABLED": "auth.oidc.enabled",
    "CODEX_AUTH_OIDC_PROVIDER_NAME": "auth.oidc.provider_name",
    "CODEX_AUTH_OIDC_SERVER_URL": "auth.oidc.server_url",
    "CODEX_AUTH_OIDC_CLIENT_ID": "auth.oidc.client_id",
    "CODEX_AUTH_OIDC_CLIENT_SECRET": "auth.oidc.client_secret",
    "CODEX_AUTH_OIDC_SCOPE": "auth.oidc.scope",
    "CODEX_AUTH_OIDC_PKCE": "auth.oidc.pkce",
    "CODEX_AUTH_OIDC_TOKEN_AUTH_METHOD": "auth.oidc.token_auth_method",
    "CODEX_AUTH_OIDC_FETCH_USERINFO": "auth.oidc.fetch_userinfo",
    "CODEX_AUTH_OIDC_USERNAME_CLAIM": "auth.oidc.username_claim",
    "CODEX_AUTH_OIDC_CREATE_USERS": "auth.oidc.create_users",
    "CODEX_AUTH_OIDC_LINK_BY_EMAIL": "auth.oidc.link_by_email",
    "CODEX_AUTH_OIDC_SYNC_GROUPS": "auth.oidc.sync_groups",
    "CODEX_AUTH_OIDC_GROUPS_CLAIM": "auth.oidc.groups_claim",
    "CODEX_AUTH_OIDC_ADMIN_GROUP": "auth.oidc.admin_group",
    "CODEX_AUTH_OIDC_RP_INITIATED_LOGOUT": "auth.oidc.rp_initiated_logout",
    # Debug
